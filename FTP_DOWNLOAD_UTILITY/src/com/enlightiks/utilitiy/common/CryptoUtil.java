 ...
 * @author Brijesh
 */
public final class CryptoUtil implements DecryptInterface{
...
//  private static Cipher ecipher;
    ...
    public CryptoUtil() { 
    	log = Logger.getLogger(CryptoUtil.class);
	 ...
	 * @param decrypted email id password
	 */
